<script lang="ts">
    ...
    const textColour =
        colour === "amber"
            ? "text-amber-300 shadow-amber-300/60"
            : colour === "fuchsia"
            ? "text-fuchsia-300 shadow-fuchsia-300/60"
            : "text-indigo-300 shadow-indigo-300/60";
...
<div class="w-full {cardStyles} {roundedStyles}">
