...
<div class="text-center mt-14">
    ...
    <p class="text-zinc-400">
        Support the continuous development of wordPractice and receive some cool
        perks.
    </p>
</div>

<div
    class="flex items-center mt-12 lg:flex-row flex-col lg:gap-0 gap-5 mx-auto justify-center"
>
    <MembershipCard
        name="Light"
        price="2.99"
